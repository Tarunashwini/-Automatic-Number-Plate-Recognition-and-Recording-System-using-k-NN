...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("C:/Users/Tarun/OneDrive/Desktop/Mini Projects/-OpenCV-kNN-Licence-Plate-Reocgnition-master/-OpenCV-kNN-Licence-Plate-Reocgnition-master/classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("C:/Users/Tarun/OneDrive/Desktop/Mini Projects/-OpenCV-kNN-Licence-Plate-Reocgnition-master/-OpenCV-kNN-Licence-Plate-Reocgnition-master/flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
    ...
    kNearest.setDefaultK(36)                                                             # set default K to 1

    kk = kNearest.train(npaFlattenedImages, cv2.ml.ROW_SAMPLE, npaClassifications)           # train KNN object

        

    with open("C:/Users/Tarun/OneDrive/Desktop/Mini Projects/-OpenCV-kNN-Licence-Plate-Reocgnition-master/-OpenCV-kNN-Licence-Plate-Reocgnition-master/knnmodel_pickle", 'wb') as f:
        pickle.dump(kk,f)
        print("Dumped")
