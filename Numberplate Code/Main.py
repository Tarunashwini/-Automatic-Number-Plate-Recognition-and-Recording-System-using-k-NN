...
def main(img_path):
    ...
    if len(listOfPossiblePlates) == 0:                          # if no plates were found
        ...
        #cv2.imshow("imgOriginalScdddene", imgOriginalScene)                # re-show scene image

        cv2.imwrite("C:/Users/Tarun/OneDrive/Desktop/Numberplate/SavedImg/R1.png", imgOriginalScene)           # write image out to file
